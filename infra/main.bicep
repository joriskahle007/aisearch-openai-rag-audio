...
// Hier wird freigegebe welcher Search Dienst genutzt und abgerechnet wird
@allowed(['basic'])
...
// Hier wird abgefragt, welche Stimme später im Bot anworten soll!
@description('Voice für die Azure OpenAI Realtime-Session (wird vom Backend bei Session-Erstellung verwendet).')
@allowed([
'alloy'
'ash'
'ballad'
